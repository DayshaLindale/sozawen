...
TOOLS = {
    ...
    "practice":     {"label": "Practice Mode",    "icon": "🎓", "group": "perform",
    ...
    "spatial":      {"label": "Spatial Audio",      "icon": "🌐", "group": "mix",
                     "tip": "Position sounds in 3D space — left/right, front/back, up/down. Drag the dot on the circular panner. Renders to binaural stereo for headphones. For immersive mixing, spatial music, and game audio."},
    "video_sync":   {"label": "Video Sync",        "icon": "🎬", "group": "edit",
                     "tip": "Score to picture. Load a video, sync it to your timeline. Video plays in lockstep with audio — for film scoring, music videos, game audio. Pop out for larger view while composing."},
    "plugins":      {"label": "VST3 Plugins",      "icon": "🔧", "group": "mix",
                     "tip": "Scan and load third-party VST3 effects and instruments. Extends Sozawen with any plugin you already own. Scanner detects installed plugins automatically."},
    "pdf_export":   {"label": "PDF Score",         "icon": "📄", "group": "master",
                     "tip": "Export your score as a printable PDF. Opens as a print-ready page — use Ctrl+P to save as PDF. Includes proper notation with all markings. For sharing charts, teaching, or archiving compositions."},
    "clip_launcher":{"label": "Clip Launcher",     "icon": "🎪", "group": "perform",
                     "tip": "Trigger loops and clips in real-time. Load audio into slots, click to play/stop. Layer clips to build grooves live. Like Ableton Session View — for jamming and live performance."},
    "warp":         {"label": "Warp/Stretch",     "icon": "↕", "group": "edit",
                     "tip": "Time-stretch audio without changing pitch. Fit a recording to a different tempo. Uses phase vocoder — pure math, no artifacts at moderate stretch ratios. Use to match imported audio to your project BPM."},
    "audio_to_drums":{"label":"Audio to Drums",   "icon": "🥁", "group": "edit",
                     "tip": "Detect beats and transients in audio, generate a drum pattern that matches the groove. Load a song, detect its rhythm, get a pattern you can edit in the drum machine."},
    "hardware":     {"label": "Hardware",          "icon": "🔌", "group": "perform",
                     "tip": "See everything plugged in — interfaces, MIDI, controllers. Create hardware inserts to route audio through external EQ boards, compressors, pedals, preamps. Your gear becomes part of the Sozawen signal chain."},
